...
class CompatSource extends Source {
	...
	streamTo(writableStream, callback) {
		// Delegate to the wrapped source's streamTo if available
		if (typeof this._sourceLike.streamTo === "function") {
			return this._sourceLike.streamTo(writableStream, callback);
		}
		
		// Fallback to default implementation
		return super.streamTo(writableStream, callback);
	}
